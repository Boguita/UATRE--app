                ...
                ListView(
                  ...
                  children: <Widget>[
                    ...
                    getDrawerMenuItem(context,
                        CustomMenuItem.get(CustomMenuItemType.homePage, widget.user)),
                    getDrawerMenuItem(context,
                       CustomMenuItem.get(CustomMenuItemType.history, widget.user)),
                    getDrawerMenuItem(context,
                        CustomMenuItem.get(CustomMenuItemType.nosotros, widget.user)),
                    getDrawerMenuItem(
                        context, CustomMenuItem.get(CustomMenuItemType.news, widget.user)),
                    getDrawerMenuItem(
                        context, CustomMenuItem.get(CustomMenuItemType.media, widget.user)),
                    getDrawerMenuItem(context,
                        CustomMenuItem.get(CustomMenuItemType.beneficts, widget.user)),
                    getDrawerMenuItem(context,
                        CustomMenuItem.get(CustomMenuItemType.prestamo, widget.user)),
                    getDrawerMenuItem(context,
